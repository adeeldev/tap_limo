...
$banner_options       		= offtheshelf_option('the_banner_options');

$banner_background_mode		= offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'background_mode', $banner_options);
$banner_color_1 			= offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'color_1', $banner_options, '#ffffff');
$banner_color_2 			= offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'color_2', $banner_options, '#ffffff');
$banner_image				= offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'background_image', $banner_options, false, true);

$banner_body_font = offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'font_banner_text', $banner_options, false, true);
...
<?php echo $f->get_typography_css( offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'font_banner_title', $banner_options, false, true) ); ?>
}

#banner #banner_content h2.regular-sub-title, #banner #banner_content h2.section-sub-title {
<?php echo $f->get_typography_css( offtheshelf_custom_value(OFFTHESHELF_OPTIONS_PREFIX . 'font_banner_sub_title', $banner_options, false, true) ); ?>
}
...
border-left: 1px solid <?php echo offtheshelf_hex2rgba($banner_text_color, .15); ?>;
}
...
border-left: 1px solid <?php echo offtheshelf_hex2rgba(offtheshelf_option('header_text'), .15); ?>;
}