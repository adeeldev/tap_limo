 ...
 */
var profile_tabs = {
	general: ['#offtheshelf_profile_design'],
	header: ['#offtheshelf_profile_header', '#offtheshelf_profile_multipurpose', '#offtheshelf_profile_sub_header'],
	footer: ['#offtheshelf_profile_footer', '#offtheshelf_profile_subfooter'],
	buttons: ['#offtheshelf_profile_navigation', '#offtheshelf_profile_call_to_action'],
	typography: ['#offtheshelf_profile_fonts'],
	social: ['#offtheshelf_profile_social', '#offtheshelf_profile_twitter'],
	advanced: ['#offtheshelf_profile_advanced']
};
...
jQuery(function($){
	...
	$(document).on('click', 'input.clear-img-widget', function(event){
		...
		image_field.val('');
		preview = image_field.prev().find('.ots-widget-preview-image');
